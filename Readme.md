Source code for article published @ https://2much2learn.com/rest-api-design-first-development-with-apicurio/

# Docker-compose based installation for Apicurio Studio
